...
<head>
    ...
    <!-- <link rel="stylesheet" href="../front-end/fullcalendar/css/bootstrap.min.css"> -->
    <!-- FullCalendar -->
            ...
            <div class="modal-dialog">
                <div class="modal-content fondo-agregar">
                    <div class="modal-header">
                        <h5 class="modal-title titulo-modal-agregar">Ver Evento</h5>
                        ...
                        <div class="container-fluid">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <div class="input-group input-group-dynamic input-group-custom mb-4 my-3">
                                        ...
                                        <input style="cursor:text;" type="text" id="title" class="form-control custom-modal-agregar" disabled>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="input-group input-group-dynamic input-group-custom mb-4 my-3">
                                    ...
                                    <textarea style="cursor:text;" type="text" id="description" class="form-control custom-modal-agregar" disabled></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
