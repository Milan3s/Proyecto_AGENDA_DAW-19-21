...
<body class="body-proyecto">
                    ...
                    <div class="bg-gradient-info shadow-info border-radius-lg pt-1">
                      <div class="centrar-agregar">
                        ...
                        <div class="centrar-boton-agregarContactos">
                          <button class="btn btn-icon btn-2 btn-success boton-agregar" data-bs-toggle="modal" data-bs-target="#AgregarContactos">
                  ...
                  <div class="card-body px-4 pb-2">
                    <div class="alinear_tabla">
                      <table class="table align-items-center justify-content-center mb-0 display" id="tabla_contactos">
                        ...
                        <tbody class="alinear_tabla_contacto">
                          <div class="text-center">
                            ...
                            ?>
                              <div class="alert alert-success text-center" style="margin-top:20px;">
                                <?php echo $_SESSION['message_contactos']; ?>
                              </div>
                          ...
                          ?>
                              <tr>
                                ...
                                <td>
                                  <span class="my-3 mover-acciones text-info" data-bs-toggle="modal" data-bs-target="#editar<?php echo $fila_contactos['id_contactos']; ?>"><i class="fa fa-pencil cursor" aria-hidden="true"></i></span>
                                </td>
                                <!--  -->
                                <?php include('../panel_colaborador/Formu-Editar-Contactos.php'); ?>
  ...
  <?php include('../panel_colaborador/Formu-Agregar-Contactos.php'); ?>
