...
<body class="body-proyecto">
                    ...
                    <div class="bg-gradient-info shadow-info border-radius-lg pt-1">
                      <div class="centrar-agregar">
                        ...
                        <div class="centrar-boton-agregarContactos">
                          <button class="btn btn-icon btn-2 btn-success boton-agregar" data-bs-toggle="modal" data-bs-target="#c_AgregarAgenda">
                        ...
                        <tbody class="alinear_tabla_contactos">
                          ...
                          ?>
                              <tr>
                                ...
                                <?php include('../panel_colaborador/Formu-Editar-Agenda.php'); ?>
                                <!-- Incluimos el modal Borrar y Editar -->
                              </tr>
                          <?php
                            }
                          } catch (PDOException $err_agenda) {
                            echo "No se encontraron datos : " . $err_agenda->getMessage();
                            echo "Error en la línea : " . $err_agenda->getLine();
                          }
                          ?>
                        </tbody>
                      </table>
  ...
  <?php include('../panel_colaborador/Formu-Agregar-Agenda.php'); ?>
