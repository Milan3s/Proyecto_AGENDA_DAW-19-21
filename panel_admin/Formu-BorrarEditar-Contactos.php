                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-dynamic mb-4 my-3">
                                ...
                                <input id="imagenes" type="file" name="idioma" class="custom-modal-imagenes">
                                <div>
                                    <img src="../subida_de_archivos/<?php echo $fila_contactos['idioma']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group input-group-dynamic mb-4 my-3">
                                ...
                                <input type="file" id="imagenes" name="foto_contacto" class="custom-modal-contacto">
                                <div id="preview-foto">
                                    <img style="width:40px;" src="../subida_de_archivos/<?php echo $fila_contactos['foto']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
